    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400">Carregando guias contábeis...</p>
        </div>
      </div>
    )
  }
        ...
        <div className="max-w-4xl mx-auto">
          <Card className="mb-6 dark:bg-gray-900 dark:border-gray-800">
            <CardHeader>
              ...
              <CardTitle className="text-2xl dark:bg-gray-900 dark:border-gray-800">{selectedGuide.title}</CardTitle>
              <CardDescription className="text-lg dark:bg-gray-900 dark:border-gray-800">{selectedGuide.description}</CardDescription>
            </CardHeader>
          </Card>
                ...
                {selectedGuide.steps.map((step) => (
                  <div key={step.id} className="border-l-4 border-blue-500 pl-4">
                    ...
                    {step.substeps && step.substeps.length > 0 && (
                      <div className="mb-3">
                        <h4 className="font-medium text-gray-800 dark:text-gray-200 mb-1">Substeps:</h4>
                        <ul className="list-disc list-inside space-y-1">
                          {step.substeps.map((substep, index) => (
                            <li key={index} className="text-gray-600 dark:text-gray-400">{substep}</li>
                          ))}
                        </ul>
                      </div>
                    )}
                    ...
                    {step.tips && step.tips.length > 0 && (
                      <div className="mb-3">
                        <h4 className="font-medium text-blue-700 dark:text-blue-300 mb-1">💡 Dicas:</h4>
                        <ul className="list-disc list-inside space-y-1">
                  ...
                  <div key={index} className="p-3 border rounded-lg">
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400">{law.title}</p>
    ...
    <div className="container mx-auto p-6">
      ...
      <div className="mb-6 flex flex-wrap gap-4">
        ...
        <select
          ...
          onChange={(e) => setDifficultyFilter(e.target.value as unknown)}
          className="px-3 py-2 border rounded-md"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredGuides.map((guide) => (
          <Card key={guide.id} className="hover:shadow-lg transition-shadow bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800 cursor-pointer dark:bg-gray-900 dark:border-gray-800">
            <CardHeader>
              ...
              <CardTitle className="text-lg dark:bg-gray-900 dark:border-gray-800">{guide.title}</CardTitle>
