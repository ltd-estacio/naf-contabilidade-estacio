            ...
            <CardContent>
              <form onSubmit={handleSubmitDemand} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="demand-title" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                      Título da Demanda *
                    </label>
                    <Input
                      id="demand-title"
                  ...
                  <div>
                    <label htmlFor="demand-category" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                      Categoria *
                    </label>
                    <select
                      id="demand-category"
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    <label htmlFor="demand-theme" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                      Tema *
                    </label>
                    <select
                      id="demand-theme"
                  ...
                  <div>
                    <label htmlFor="demand-priority" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                      Prioridade
                    </label>
                    <select
                      id="demand-priority"
                  ...
                  <div>
                    <label htmlFor="demand-estimated-hours" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                      Horas Estimadas
                    </label>
                    <Input
                      id="demand-estimated-hours"
                      type="number"
                      step="0.5"
                ...
                <div>
                  <label htmlFor="demand-description" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                    Descrição Detalhada *
                  </label>
                  <textarea
                ...
                <div>
                  <label htmlFor="demand-due-date" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
        ...
        <Card className="mb-6">
          <CardContent className="p-4">
            <div className="flex flex-wrap gap-4 items-center">
              ...
              <select className="h-10 px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md">
