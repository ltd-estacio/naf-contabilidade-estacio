...
export default function CoordinatorDashboard() {
  ...
  // Links antigos removidos - agora usando MainNavigation
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <p className="text-slate-600 font-medium">
                      {user?.email?.split('@')[0]?.toUpperCase()} | Painel Executivo
                    </p>
                  </div>
                </div>
              </div>
              ...
              <nav className="flex items-center gap-1">
                ...
                <div className="relative group">
                  ...
                  <div className="absolute hidden group-hover:block top-full left-0 mt-2 w-64 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 py-2 z-[9999]">
                    <Link href="/student-portal" className="flex items-center gap-3 px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700">
                      <span className="text-sm">Portal do Estudante</span>
                    </Link>
                    <Link href="/coordinator-dashboard" className="flex items-center gap-3 px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700">
                      <span className="text-sm">Dashboard Coordenador</span>
                    </Link>
                    <Link href="/naf-management" className="flex items-center gap-3 px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700">
                      <span className="text-sm">Gestão NAF</span>
                    </Link>
                  </div>
                </div>
                ...
                <div className="relative group">
                  ...
                  <div className="absolute hidden group-hover:block top-full left-0 mt-2 w-64 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 py-2 z-[9999]">
                    <Link href="/naf-scheduling" className="flex items-center gap-3 px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700">
                      <span className="text-sm">Agendamento</span>
                    </Link>
                    <Link href="/services" className="flex items-center gap-3 px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700">
                      <span className="text-sm">Serviços NAF</span>
                    </Link>
                    <Link href="/fiscal-guides" className="flex items-center gap-3 px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700">
                      <span className="text-sm">Guias Fiscais</span>
                    </Link>
                    <Link href="/schedule" className="flex items-center gap-3 px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700">
                      <span className="text-sm">Agenda Geral</span>
                    </Link>
                  </div>
                </div>
                ...
                <div className="relative group">
                  ...
                  <div className="absolute hidden group-hover:block top-full right-0 mt-2 w-64 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 py-2 z-[9999]">
                    <Link href="/student-login-simple" className="flex items-center gap-3 px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700">
                      <span className="text-sm">Login Estudante</span>
                    </Link>
                    <Link href="/coordinator-login" className="flex items-center gap-3 px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700">
                      <span className="text-sm">Login Coordenador</span>
                    </Link>
                    <Link href="/student-register" className="flex items-center gap-3 px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700">
                      <span className="text-sm">Cadastro Estudante</span>
                    </Link>
                  </div>
                </div>
              </nav>
