  ...
  useEffect(() => {
    const checkAuth = async () => {
      try {
        ...
        // Pequeno delay para garantir que a camada de armazenamento esteja acessível
        await new Promise(resolve => setTimeout(resolve, 100))

        const { token, user } = await studentSession.load()
        ...
        if (!token) {
          console.log('⚠️ Token não encontrado, redirecionando...')
        ...
        if (user) {
          setUser(user as StudentProfile)
        }
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 font-semibold mt-1">ESTUDANTE | Painel Acadêmico</p>
                  </div>
                </div>
              </div>
            </div>
