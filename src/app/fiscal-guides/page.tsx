...
type OfficialDocs = {
  title?: string
  laws?: Array<{ type?: string; year?: string; name?: string; pdfUrl?: string; url?: string }>
  officialSites?: Array<{ name?: string; description?: string; url?: string }>
}

declare global {
  interface Window {
    // function assigned dynamically when modal is created
    closeModal?: () => void
  }
}
...
export default function FiscalGuidesPage() {
  ...
  const showOfficialDocumentsModal = (data: OfficialDocs) => {
    const modalContent = `
    ...
    // Adicionar função de fechar ao window (tipada globalmente)
    window.closeModal = () => {
              ...
              <div className="text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Link href="/services">
                    <Button
                      size="lg"
                      className="border border-white text-white bg-transparent hover:bg-white hover:text-blue-600 transition-colors duration-150 dark:border-gray-700 dark:text-white dark:hover:bg-gray-800 dark:hover:text-blue-400"
                    >
