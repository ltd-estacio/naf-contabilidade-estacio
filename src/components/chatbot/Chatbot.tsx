    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <Card className="w-full max-w-2xl h-[80vh] flex flex-col">
        <CardHeader className="border-b bg-blue-600 text-white rounded-t-lg">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-white dark:bg-gray-950 dark:bg-gray-950 bg-opacity-20 rounded-full flex items-center justify-center">
            ...
            <div className="flex items-center space-x-2">
              <Button 
                ...
                className="text-white hover:bg-white dark:bg-gray-950 hover:bg-opacity-20"
              >
                🆕 Nova Conversa
              </Button>
              <Button 
        ...
        <div className="border-b p-3 bg-gray-50">
          <p className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Categoria da sua dúvida:</p>
        ...
        <CardContent className="flex-1 overflow-y-auto p-4 space-y-4">
                ...
                <div className={`flex items-center justify-between mt-2 text-xs ${
                  ...
                  {message.confidence !== undefined && !message.isUser && (
                    <div className="flex items-center space-x-1">
                      {message.source && (
                        <span className="px-2 py-1 bg-blue-100 dark:bg-blue-900 text-blue-800 rounded text-xs">
          ...
          {isLoading && (
            <div className="flex justify-start">
              <div className="bg-gray-100 dark:bg-gray-800 dark:bg-gray-800 p-3 rounded-lg">
                <div className="flex items-center space-x-2">
        ...
        <div className="border-t p-3 bg-gray-50">
          <p className="text-xs font-medium text-gray-600 dark:text-gray-400 mb-2">Perguntas frequentes:</p>
          <div className="flex flex-wrap gap-2">
