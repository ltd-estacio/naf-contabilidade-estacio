        ...
        <div className={`flex items-center h-16 ${showBrand ? 'justify-between' : 'justify-center'}`}>
          ...
          <div className={`hidden lg:flex items-center space-x-1 ${!showBrand ? 'flex-1 justify-center' : ''}`}>
            ...
            <div className="relative">
              ...
              {dropdowns.portals && (
                <div className="absolute top-full left-0 mt-2 w-64 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 py-3 z-50 nav-dropdown">
            ...
            <div className="relative">
              ...
              {dropdowns.management && (
                <div className="absolute top-full right-0 mt-2 w-64 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 py-3 z-50 nav-dropdown">
